...
function App() {
  ...
  return (
    ...
    <div>
      ...
      <div><strong>{usdGBP_Value}</strong> <small> GBP</small></div>
      <div><strong>{usdJPY_Value}</strong> <small> JPY</small></div>
      <div><strong>{usdEUR_Value}</strong> <small> EUR</small></div>
